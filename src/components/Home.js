  ...
  return (
    <Home>
        ...
        <HomeRow className='home__row'>
            <Product key={1} desc="The Lean Startup : How Constant Innovation Creates Radically Succesfull Business PaperBack"
                     price='11.96'
                     productImg = 'https://images-na.ssl-images-amazon.com/images/I/81-QB7nDh4L.jpg'
                     rating={3}
                     id={1}/>

            <Product key={2}  productImg='https://images-na.ssl-images-amazon.com/images/I/41o5PJi5v3L._SX327_BO1,204,203,200_.jpg'
        ...
        <HomeRow className='home__row'>
            <Product key={3}  productImg='https://m.media-amazon.com/images/I/719sMfG+11L._AC_UL320_.jpg'
                     desc='MSI Gaming GF63 Thin, Intel 11th Gen. i7-11800H, 40CM FHD 144Hz Gaming Laptop '
                     price={1107}
                     rating={4}
                     id={3}/>

            <Product key={4} productImg='https://images-eu.ssl-images-amazon.com/images/I/31IdiM9ZM8L._SX300_SY300_QL70_FMwebp_.jpg'
                     desc='boAt Bassheads 100 in Ear Wired Earphones with Mic(Black)'
                     price={10}
                     rating={3}
                     id={4}/>

            <Product key={5}  productImg='https://m.media-amazon.com/images/I/61ahn9N38zL._AC_UY218_.jpg'
        ...
        <HomeRow className='home__row'>
            <Product key={6} productImg='https://images-eu.ssl-images-amazon.com/images/I/415CwforHgL._SY300_SX300_QL70_FMwebp_.jpg'
